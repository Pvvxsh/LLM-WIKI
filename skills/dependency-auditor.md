...
See [README.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/skills/dependency-auditor/README.md) for detailed usage and `references/` for the vulnerability/license knowledge bases.