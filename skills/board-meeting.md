...
### PHASE 4: Synthesis
Chief of Staff delivers using the **Board Meeting Output** format (defined in [`agent-protocol/SKILL.md`](https://github.com/alirezarezvani/claude-skills/tree/main/c-level-advisor/skills/agent-protocol/SKILL.md)):
...
Uses the canonical two-layer decision memory (see [`agent-protocol/SKILL.md`](https://github.com/alirezarezvani/claude-skills/tree/main/c-level-advisor/skills/agent-protocol/SKILL.md) → "Decision Memory (Canonical Layout)"):
