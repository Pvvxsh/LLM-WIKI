---
title: "youtube-full — YouTube Transcripts, Search, and Channel Data — Agent Skill for Marketing"
description: "Use when the user needs YouTube transcripts, video search, channel browsing, playlist extraction, or content monitoring. Trigger phrases: 'get the. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/alirezarezvani/claude-skills/tree/main/marketing-skill/skills/youtube-full/SKILL.md">Source</a></span>
</div>
