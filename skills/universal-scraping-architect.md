---
title: "Universal Scraping Architect — Agent Skill for Codex & OpenClaw"
description: "Use for web scraping, crawling, document extraction, API parsing, or building validation-heavy data pipelines using Firecrawl or local Python scripts. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
